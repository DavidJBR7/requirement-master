...
export function Layout() {
  ...
  return (
    <div className="flex h-screen bg-gray-50">
      {/* Sidebar */}
      <aside
        className={`flex flex-col bg-gradient-to-br from-blue-500 via-blue-600 to-blue-800 transition-all duration-300 ease-in-out ${
          collapsed ? "w-18" : "w-66"
        }`}
      >
        {/* Logo y toggle */}
        <div className="p-4 border-b border-blue-600 flex items-center gap-3">
          <button
            ...
            className="w-10 h-10 flex items-center justify-center rounded-xl hover:bg-blue-600 transition-colors flex-shrink-0 bg-blue-700 cursor-pointer"
