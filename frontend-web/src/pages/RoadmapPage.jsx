...
export default function RoadmapPage() {
  ...
  if (error) return (
    <div className="text-center py-20">
      <p className="text-red-600">Error al cargar el roadmap. Intenta nuevamente.</p>
    </div>
  );
  ...
  return (
    <section aria-labelledby="roadmap-heading" className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="bg-blue-50 rounded-2xl shadow-md p-8 border border-gray-100 sticky top-8">
            <div className="space-y-6">
              ...
              <h2 className="text-2xl font-bold text-gray-900 leading-tight">
                Este es el camino para convertirte en el mejor levantador de requerimientos
              </h2>

              <div className="space-y-4 text-gray-600">
                <p className="leading-relaxed">
                  Cada paso está diseñado para llevarte del <span className="font-semibold text-gray-900">no sé por dónde empezar</span> al{' '}
                  <span className="font-semibold text-gray-900">dominio total</span> de las técnicas de elicitación, 
                  análisis y documentación de requerimientos.
                </p>

                <p className="leading-relaxed">
                  No importa si estás empezando desde cero o si ya tienes experiencia: esta ruta te guiará 
                  de manera progresiva, asegurando que cada concepto quede sólido antes de avanzar al siguiente nivel.
                </p>
                ...
                <div className="border-t border-gray-100 pt-4">
                  ...
                  <ul className="space-y-2 text-sm">
                    <li className="flex items-start gap-2">
                      ...
                      <span>Dominar entrevistas efectivas con stakeholders</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="text-green-500 mt-0.5">✓</span>
                ...
                <div className="bg-gradient-to-br from-blue-200 to-indigo-200 rounded-xl p-4 border border-blue-100">
                  <p className="text-sm text-blue-800 font-medium">
                    💡 <span className="font-semibold">Tip:</span> Tómate tu tiempo en cada lección. 
